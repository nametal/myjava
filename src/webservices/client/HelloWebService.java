 ...
 * 
 */
@WebServiceClient(name = "HelloWebService", targetNamespace = "http://server.webservices/", wsdlLocation = "http://localhost:2487/Helow?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOWEBSERVICE_QNAME = new QName("http://server.webservices/", "HelloWebService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:2487/Helow?wsdl");
    ...
    public HelloWeb getHelloWebPort() {
        return super.getPort(new QName("http://server.webservices/", "HelloWebPort"), HelloWeb.class);
    }
    ...
    public HelloWeb getHelloWebPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://server.webservices/", "HelloWebPort"), HelloWeb.class, features);
    }
