...
public class ObjectFactory {
    ...
    private final static QName _Greet_QNAME = new QName("http://server.webservices/", "greet");
    private final static QName _GreetResponse_QNAME = new QName("http://server.webservices/", "greetResponse");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.webservices/", name = "greet")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.webservices/", name = "greetResponse")
